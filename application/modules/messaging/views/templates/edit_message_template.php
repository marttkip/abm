                	 ...
                	 <div class="alert alert-info"> 
                       ...
                       <div class="row">
                        ...
                        <div class="row center-align">
                            ...
                            <p><strong>Good monring [name]. Your account balance as at <?php echo date('Y-m-d');?> is [balance]</strong></p>
                        </div>
                        <hr>
                        <div class="row center-align">
                            <strong>Description Example:</strong>
                            <p><strong>Good monring [Firstname. Please be reminded to go register as a voter in [Constituencyname] at the [Pollingstationname] Polling Station</strong></p>
                        </div>
