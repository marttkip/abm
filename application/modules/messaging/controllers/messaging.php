	...
	*/
	...
	public function template_detail($message_template_id)
	{
		...
		foreach ($rs8 as $property_rs) :
			$Countyname = $property_rs->Countyname;
	...
	public function view_persons_for_batch($message_batch_id,$message_template_id)
	{
		...
		$where = 'messages.message_batch_id = message_batch.message_batch_id AND messages.entryid = allcounties.entryid AND messages.message_batch_id = '.$message_batch_id;
		$table = 'messages,message_batch,allcounties';
		$segment = 4;
		//pagination
		$this->load->library('pagination');
